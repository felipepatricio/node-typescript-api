...
const debug = debug_1.default('tsc:source:manager');
/**
...
class SourceFilesManager {
    constructor(appRoot, options) {
        ...
        this.isWindows = os_1.platform() === 'win32';
        /**
         * Pattern matcher for included files
         */
        this.whitelisted = picomatch_1.default((this.options.includes || []).map((pattern) => {
            return this.normalizeSlashToUnix(path_1.join(this.appRoot, pattern));
        }));
        /**
         * Pattern matcher for excluded files
         */
        this.blacklisted = picomatch_1.default((this.options.excludes || []).map((pattern) => {
            return this.normalizeSlashToUnix(path_1.join(this.appRoot, pattern));
        }));
        /**
         ...
         */
        this.matchAgainstPattern = mem_1.default((filePath) => {
