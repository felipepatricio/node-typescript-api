...
const debug = debug_1.default('tsc:config:parser');
/**
...
class ConfigParser {
    ...
    parse(optionsToExtend) {
        ...
        const parsedConfig = this.ts.getParsedCommandLineOfConfigFile(path_1.join(this.cwd, this.configFileName), optionsToExtend || {}, {
            ...this.ts.sys,
