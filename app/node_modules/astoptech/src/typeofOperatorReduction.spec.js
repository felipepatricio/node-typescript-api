...
tree.replace({ enter: typeofOperatorReduction })
assert.deepStrictEqual(tree.source, 'const foo = "string";\n')

var tree = new AbstractSyntaxTree('const foo = typeof 42\n')
tree.replace({ enter: typeofOperatorReduction })
assert.deepStrictEqual(tree.source, 'const foo = "number";\n')

var tree = new AbstractSyntaxTree('const foo = typeof []\n')
tree.replace({ enter: typeofOperatorReduction })
assert.deepStrictEqual(tree.source, 'const foo = "object";\n')
...
tree.replace({ enter: typeofOperatorReduction })
assert.deepStrictEqual(tree.source, 'const foo = "undefined";\n')
